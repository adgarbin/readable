...
class PostForm extends React.Component {
  ...
  submitForm = isSuccess => {
    ...
    else this.props.onFormSubmit(this.createPost());
  };
    ...
    return (
      <form className="formContainer" noValidate autoComplete="on">
        ...
        <TextField
          ...
          onChange={this.onFieldChange("category")}
...
const mapStateToProps = ({ categories }) => {
  const categoryArray = categories.entities
    ? Object.entries(categories.entities)
    : [];
